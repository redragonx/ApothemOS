...
* C++ Signature vpod* GetMailBoxBase()
*/
...
MailboxWrite:              /*Method to implement sending procedure.*/
   ...
   tst r0,#0b1111          
                            /* tst reg,#val computes and reg,#val and compares 
			                *  the result with 0. In this case it checks that 
                            *  the lowest 4 bits of the input in r0 are all 0
                            */

   movne pc,lr              /*Lower bits not equal to, Return*/
...
*/
      ...
      wait1$:			 /* 
                         * Subroutine to Check the top bit is 0. If not, 
			  	         * go back to 3.
                         */
         ...
         ldr status,[mailbox,#0x18]
                                    /* Load status with mailbox addr base +
...
*/
         ...
         tst status,#0x80000000	
                                /*
                                * Performs logical 'and' on #val and status
...
*/
   ...
   rightmail$:                  /*Beginning of rightmail loop*/
      wait2$:				    /*beginning of wait2 loop*/
         ...
         ldr status,[mailbox,#0x18] 
                                    /*
                                    * Load status with the mailbox address
                                    * plus 0x18 (24)
                                    */
...
*/
         ...
         teq inchan,channel         /*
                                    *Test to see that inchan and channel
					                *are equal
                                    */

         .unreq inchan              /*Unalias inchan*/
            bne rightmail$          /*If not equal, branch to beginng of loop*/
         .unreq mailbox             /*Unalias mailbox*/
         .unreq channel             /*Unalias channel*/
...
*/
         ...
         and r0,mail,#0xfffffff0	
                                    /*
                                    * 'and' mail and #val and store in r0
                                    * for return
                                    */
